<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageSimple.aspx.cs" Inherits="SMIZEE.Account.ManageSimple" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section id="passwordForm">
        ...
        <asp:PlaceHolder runat="server" ID="changePassword" Visible="true">
            ...
            <asp:ChangePassword ID="ChangePassword1" runat="server" CancelDestinationPageUrl="~/" ViewStateMode="Disabled" RenderOuterTable="false" SuccessPageUrl="ManageSimple.aspx?m=ChangePwdSuccess">
                <ChangePasswordTemplate>
                    ...
                    <fieldset class="changePassword">
                        ...
                        <asp:Button ID="Button2" runat="server" CommandName="ChangePassword" Text="Change password" ValidationGroup="ChangePassword"   OnClick="OnPasswordChange"/>
                    </fieldset>
                </ChangePasswordTemplate>
            </asp:ChangePassword>
        </asp:PlaceHolder>
