<%@ Page Title="Inicio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SMI.03.03.aspx.cs" Inherits="SMIZEE.Forms.SMI_03_03" %>
        ...
        AutoGenerateColumns="False" BorderWidth="0px" AllowPaging="False" PageSize="10">
            <Columns>
                ...
                <asp:TemplateField ItemStyle-Width="10%" HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Right"   
                    ...
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="OperationalLicensesFormIdLabel" runat="server" Text='<%# Eval("OperationalLicensesFormId") %>'></asp:Label>
                       <asp:HiddenField id="OperationalLicenceFormIdHidden" runat="server" Value='<%# Eval("OperationalLicensesFormId") %>'></asp:HiddenField>
...
<asp:Panel ID="FormPanel" runat="server" Width="100%" Visible="False" ScrollBars="Auto">
        <asp:GridView ID="FormGridView" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both" Width="100%" CssClass="gridview"
            OnRowDataBound="OnFormGridViewRowDataBound"
            AutoGenerateColumns="False" BorderWidth="0px" AllowPaging="False" PageSize="10">
                <Columns>
                    <asp:TemplateField ItemStyle-Width="80%" HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Left"
                        HeaderText="<%$ Resources:Resource, lDevelopmentPhase %>" ItemStyle-Wrap="False" 
                        SortExpression="">
                        <ItemTemplate>
                            <asp:Label id="DevelopmentPhaseDescriptionLabel" runat="server" Text='<%# Eval("Description") %>'></asp:Label>
                            <asp:HiddenField id="DevelopmentPhaseIdHidden" runat="server" Value='<%# Eval("DevelopmentPhaseId") %>'></asp:HiddenField>
                        </ItemTemplate>
                        <HeaderStyle Wrap="False" />
                        <ItemStyle Wrap="False" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Right"   
                        HeaderText="<%$ Resources:Resource, lProductionUnitsNumber %>" ItemStyle-Wrap="False" 
                        SortExpression="">
                        <ItemTemplate>
                            <asp:TextBox id="ProductionUnitsNumberText" ToolTip="<%$ Resources:ToolTips, ProductionUnitsNumber %>" MaxLength="9" class="numbersOnly" runat="server"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Wrap="False" />
                        <ItemStyle Wrap="False" />
                    </asp:TemplateField>
