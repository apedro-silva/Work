<%@ Page Title="Inicio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SMI.03.05.aspx.cs" Inherits="SMIZEE.Forms.SMI_03_05" %>
        ...
        AutoGenerateColumns="False" BorderWidth="0px" AllowPaging="False" PageSize="10">
            <Columns>
                ...
                <asp:TemplateField ItemStyle-Width="10%" HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Right"   
                    ...
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="HumanResourceFormIDLabel" runat="server" Text='<%# Eval("HumanResourceFormID") %>'></asp:Label>
...
<asp:Panel ID="DetailPanel" runat="server" Width="100%" Visible="False" CssClass="detail">
        ...
        <asp:Table width="100%" runat="server" border="0">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell id="TableCell10" style="width: 220px"  ColumnSpan="2">
                ...
                <asp:TableCell style="width: 150px;font-weight:bold" CssClass="entityLabel">
                    <asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:Resource, lFillDateLabel %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="TableCell11" style="width: 160px">
                    <asp:Literal ID="FillDateLiteral" runat="server" Text="dd/MM/YYY"></asp:Literal>
                </asp:TableCell>
            </asp:TableRow>

            <asp:TableRow>
                <asp:TableCell style="font-weight:bold" ColumnSpan="5">
            ...
            <asp:TableRow>
                <asp:TableCell style="width: 300px" CssClass="entityLabel">
                    <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:Resource, lNrTotalHorasFormacao %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="Td5" ColumnSpan="4">
                    <asp:TextBox ID="NrTotalHorasFormacaoInput" ToolTip="<%$ Resources:ToolTips, NrTotalHorasFormacao %>" class="numbersOnly" runat="server" Width="200px" MaxLength="9"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="AmountLiteral" runat="server" Text="<%$ Resources:Resource, lNrDiasAusenciaTrabalho %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="Td6" ColumnSpan="4">
                    <asp:TextBox ID="NrDiasAusenciaTrabalhoInput" ToolTip="<%$ Resources:ToolTips, NrDiasAusenciaTrabalho %>" class="numbersOnly" runat="server" Width="200px" MaxLength="9"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:Resource, lNrDiasUteisPeriodo %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="TableCell1" ColumnSpan="4">
                    <asp:TextBox ID="NrDiasUteisPeriodoInput" ToolTip="<%$ Resources:ToolTips, NrDiasUteisPeriodo %>" class="numbersOnly" runat="server" Width="200px" MaxLength="9"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:Resource, lNrColaboradoresAdmitidos %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="TableCell7" ColumnSpan="4">
                    <asp:TextBox ID="NrColaboradoresAdmitidosInput" ToolTip="<%$ Resources:ToolTips, NrColaboradoresAdmitidos %>" class="numbersOnly" runat="server" Width="200px" MaxLength="9"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:Resource, lNrSaidas %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="TableCell8" ColumnSpan="4">
                    <asp:TextBox ID="NrSaidasInput" class="numbersOnly" ToolTip="<%$ Resources:ToolTips, NrSaidas %>" runat="server" Width="200px" MaxLength="9"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
</asp:Panel>
...
<asp:Panel ID="ConfirmButtonPanel" runat="server" Width="100%" Visible="False" CssClass="detail">
    <asp:Table ID="Table1" width="100%" runat="server">
            <asp:TableRow>
                ...
                <asp:TableCell id="TableCell9" style="width: 75px">
...
<asp:Panel ID="ApprovePanel" runat="server" Width="100%" Visible="False" CssClass="detail">
    <asp:Table ID="Table2" width="100%" runat="server" Border="0">
            <asp:TableRow>
                <asp:TableCell id="TableCell12" style="width: 100px">
