<%@ Page Title="Inicio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SMI.03.06.aspx.cs" Inherits="SMIZEE.Forms.SMI_03_06" %>
        ...
        AutoGenerateColumns="False" BorderWidth="0px" AllowPaging="False" PageSize="10">
            <Columns>
                ...
                <asp:TemplateField ItemStyle-Width="10%" HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Right"   
                    ...
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="HumanResourceQualificationFormIDLabel" runat="server" Text='<%# Eval("HumanResourceQualificationFormID") %>'></asp:Label>
...
<asp:Panel ID="DetailPanel" runat="server" Width="100%" Visible="False" CssClass="detail">
        ...
        <asp:Table width="100%" runat="server" border="0">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell id="TableCell11" style="width: 220px"  ColumnSpan="2">
                ...
                <asp:TableCell style="width: 150px;font-weight:bold" CssClass="entityLabel">
                    <asp:Literal ID="Literal9" runat="server" Text="<%$ Resources:Resource, lFillDateLabel %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="TableCell12" style="width: 160px">
            ...
            <asp:TableRow>
                <asp:TableCell style="width: 200px" CssClass="entityLabel" RowSpan="3" VerticalAlign="Top">
                    <asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:Resource, lLocalActiveWorkers %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell style="width: 200px" CssClass="entityLabel">
                    <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:Resource, lWorkerWithLowQualification %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="Td5" ColumnSpan="3">
                    <asp:TextBox ID="LocalWorkerWithLowQualificationInput" ToolTip="<%$ Resources:ToolTips, TrabalhadorComQualificacaoBaixa %>" class="numbersOnly" runat="server" Width="200px" MaxLength="9"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="AmountLiteral" runat="server" Text="<%$ Resources:Resource, lWorkerWithMediumQualification %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="Td6" ColumnSpan="3">
                    <asp:TextBox ID="LocalWorkerWithMediumQualificationInput" ToolTip="<%$ Resources:ToolTips, TrabalhadorComQualificacaoMedia %>" class="numbersOnly" runat="server" Width="200px" MaxLength="9"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:Resource, lWorkerWithHighQualification %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="TableCell1" ColumnSpan="3">
                    <asp:TextBox ID="LocalWorkerWithHighQualificationInput" ToolTip="<%$ Resources:ToolTips, TrabalhadorComQualificacaoAlta %>" class="numbersOnly" runat="server" Width="200px" MaxLength="9"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="5" style="font-weight:bold">
            ...
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel"  RowSpan="3" VerticalAlign="Top">
                    <asp:Literal ID="Literal8" runat="server" Text="<%$ Resources:Resource, lExternalActiveWorkers %>"></asp:Literal>
                </asp:TableCell>

                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:Resource, lWorkerWithLowQualification %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="TableCell7" ColumnSpan="3">
                    <asp:TextBox ID="ExternalWorkerWithLowQualificationInput" ToolTip="<%$ Resources:ToolTips, TrabalhadorExternoComQualificacaoBaixa %>" class="numbersOnly" runat="server" Width="200px" MaxLength="9"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:Resource, lWorkerWithMediumQualification %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="TableCell8" ColumnSpan="3">
                    <asp:TextBox ID="ExternalWorkerWithMediumQualificationInut" ToolTip="<%$ Resources:ToolTips, TrabalhadorExternoComQualificacaoMedia %>" class="numbersOnly" runat="server" Width="200px" MaxLength="9"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:Resource, lWorkerWithHighQualification %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="TableCell9" ColumnSpan="3">
                    <asp:TextBox ID="ExternalWorkerWithHighQualificationInput" ToolTip="<%$ Resources:ToolTips, TrabalhadorExternoComQualificacaoAlta %>" class="numbersOnly" runat="server" Width="200px" MaxLength="9"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
</asp:Panel>
...
<asp:Panel ID="ConfirmButtonPanel" runat="server" Width="100%" Visible="False" CssClass="detail">
    <asp:Table ID="Table1" width="100%" runat="server">
            <asp:TableRow>
                ...
                <asp:TableCell id="TableCell10" style="width: 75px">
