<%@ Page Title="Inicio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SMI.03.08.aspx.cs" Inherits="SMIZEE.Forms.SMI_03_08" %>
        ...
        <asp:Table width="100%" runat="server" border="0">
            ...
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="ActiveEmployeesLiteral" runat="server" Text="<%$ Resources:Resource, lActiveEmployees %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="Td5"  ColumnSpan="2">
                    <asp:TextBox ID="ActiveEmployeesInput" ToolTip="<%$ Resources:ToolTips, NumeroTotalTrabalhadoresActivosSDZEE %>" class="numbersOnly" runat="server" Width="200px" MaxLength="9"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="EmployeesLeftLiteral" runat="server" Text="<%$ Resources:Resource, lEmployeesLeft %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="Td6"  ColumnSpan="2">
                    <asp:TextBox ID="EmployeesLeftInput" ToolTip="<%$ Resources:ToolTips, NumeroTotalTrabalhadoresSairamSDZEE %>" class="numbersOnly" runat="server" Width="200px" MaxLength="9"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:Resource, lEmployeesHired %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="TableCell1"  ColumnSpan="2">
                    <asp:TextBox ID="EmployeesHiredInput" ToolTip="<%$ Resources:ToolTips, NumeroTotalTrabalhadoresAdmitidosSDZEE %>" class="numbersOnly" runat="server" Width="200px" MaxLength="9"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
            ...
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:Resource, lTotalTrainingHours %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="TableCell7"  ColumnSpan="2">
                    <asp:TextBox ID="TotalTrainingHoursInput" ToolTip="<%$ Resources:ToolTips, NumeroTotalHorasFormacaoSDZEE %>" class="numbersOnly" runat="server" Width="200px" MaxLength="9"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
</asp:Panel>
