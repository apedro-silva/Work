<%@ Page Title="Inicio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SMI.03.07.aspx.cs" Inherits="SMIZEE.Forms.SMI_03_07" %>
...
<asp:Panel ID="DetailPanel" runat="server" Width="100%" Visible="False" CssClass="detail">
        ...
        <asp:Table width="100%" runat="server" border="0">
            ...
            <asp:TableRow>
                <asp:TableCell style="width: 350px;font-weight:bold">
                    <asp:Literal ID="FormMessageLiteral" runat="server" Text="&nbsp;"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell style="font-weight:bold" CssClass="entityLabel">
            ...
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:Resource, lValorLiquidoVendasSDZEE %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="Td5"  ColumnSpan="2">
                    <asp:TextBox ID="SalesNetAmountInput" class="numbersAndCommasOnly" runat="server" Width="200px" MaxLength="16"></asp:TextBox>Kz
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="AmountLiteral" runat="server" Text="<%$ Resources:Resource, lValorLiquidoPrestacaoServicosSDZEE %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="Td6"  ColumnSpan="2">
                    <asp:TextBox ID="ServiceDeliveryNetAmountInput" class="numbersAndCommasOnly" runat="server" Width="200px" MaxLength="16"></asp:TextBox>Kz
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell id="TableCell15"  ColumnSpan="3">&nbsp;
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:Resource, lValorActivoCirculante %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="TableCell1"  ColumnSpan="2">
                    <asp:TextBox ID="CurrentAssetsValueInput" class="numbersAndCommasOnly" runat="server" Width="200px" MaxLength="16"></asp:TextBox>Kz
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:Resource, lValorPassivoCurtoPrazo %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="TableCell7"  ColumnSpan="2">
                    <asp:TextBox ID="CurrentLiabilitiesValueInput" class="numbersAndCommasOnly" runat="server" Width="200px" MaxLength="16"></asp:TextBox>Kz
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:Resource, lValorTotalCustosSDZEE %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="TableCell8"  ColumnSpan="2">
                    <asp:TextBox ID="TotalCostValueInput" class="numbersAndCommasOnly" runat="server" Width="200px" MaxLength="16"></asp:TextBox>Kz
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal13" runat="server" Text="<%$ Resources:Resource, lValorPassivo %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="TableCell20"  ColumnSpan="2">
                    <asp:TextBox ID="LiabilityValueInput" class="numbersAndCommasOnly" runat="server" Width="200px" MaxLength="16"></asp:TextBox>Kz
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:Resource, lValorActivo %>"></asp:Literal>
                </asp:TableCell>
                <asp:TableCell id="TableCell9"  ColumnSpan="2">
                    <asp:TextBox ID="AssetValueInput" class="numbersAndCommasOnly" runat="server" Width="200px" MaxLength="16"></asp:TextBox>Kz
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
</asp:Panel>
