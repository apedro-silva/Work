<%@ Page Title="Inicio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SMI.02.05.aspx.cs" Inherits="SMIZEE.Account.SMI_02_05" %>
    ...
    <asp:Table id="Table2" width="100%" CssClass="inputtable" border="0" runat="server">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell id="TableCell6">
                <asp:TextBox ID="FunctionalAreaIdSearchInput" runat="server" MaxLength="11" Width="150px"></asp:TextBox>
            </asp:TableCell>
            ...
            <asp:TableCell id="TableCell8">
                <asp:TextBox ID="FunctionalAreaSmallDescriptionSearchInput" runat="server" MaxLength="25" Width="150px"></asp:TextBox>
            </asp:TableCell>
            ...
            <asp:TableCell id="Td4" style="width: 300px;">
                <asp:TextBox ID="FunctionalAreaDescriptionSearchInput" runat="server" MaxLength="75" Width="300px"></asp:TextBox>
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
</asp:Panel>
        ...
        AutoGenerateColumns="False" BorderWidth="0px" AllowPaging="False" PageSize="10">
            <Columns>
                ...
                <asp:TemplateField ItemStyle-Width="10%" HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Right"   
                    ...
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="FunctionalAreaIDLabel" runat="server" Text='<%# Eval("FunctionalAreaId") %>'></asp:Label>
                    </ItemTemplate>
                 ...
                 <asp:TemplateField HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Left"   
                    ...
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="FunctionalAreaSmallDescriptionLabel" runat="server" Text='<%# Eval("SmallDescription") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle Wrap="False" />
                    <ItemStyle Wrap="False" />
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Left"   
                    ...
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="FunctionalAreaDescriptionLabel" runat="server" Text='<%# Eval("Description") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle Wrap="False" />
                    <ItemStyle Wrap="False" />
                </asp:TemplateField>
