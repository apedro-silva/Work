<%@ Page Title="Inicio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SMI.02.09.aspx.cs" Inherits="SMIZEE.Account.SMI_02_09" %>
    ...
    <asp:Table id="Table2" width="100%" CssClass="inputtable" border="0" runat="server">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell id="TableCell6">
                <asp:TextBox ID="PeriodicityIdSearchInput" runat="server" MaxLength="11" Width="150px"></asp:TextBox>
            </asp:TableCell>
            ...
            <asp:TableCell id="Td4" style="width: 300px;">
                <asp:TextBox ID="PeriodicityDescriptionSearchInput" runat="server" MaxLength="75" Width="300px"></asp:TextBox>
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
</asp:Panel>
        ...
        AutoGenerateColumns="False" BorderWidth="0px" AllowPaging="False" PageSize="10">
            <Columns>
                ...
                <asp:TemplateField ItemStyle-Width="10%" HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Right"   
                    ...
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="PeriodicityIDLabel" runat="server" Text='<%# Eval("PeriodicityId") %>'></asp:Label>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Left"   
                    ...
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="PeriodicityDescriptionLabel" runat="server" Text='<%# Eval("Description") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle Wrap="False" />
                    <ItemStyle Wrap="False" />
                </asp:TemplateField>
                <asp:TemplateField HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Left"   
                    HeaderText="<%$ Resources:Resource, lPeriodicityCode %>" ItemStyle-Wrap="False" 
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="PeriodicityCodeLabel" runat="server" Text='<%# Eval("Code") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle Wrap="False" />
                    <ItemStyle Wrap="False" />
                </asp:TemplateField>
...
<asp:Panel ID="DetailPanel" runat="server" Width="100%" Visible="False" CssClass="xdetail">
        <asp:Table width="100%" runat="server">
            ...
            <asp:TableRow>
                <asp:TableCell style="width: 100px" CssClass="entityLabel">
                    <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:Resource, lPeriodicityCode %>"></asp:Literal></asp:TableCell>
                <asp:TableCell id="TableCell1">
                    <asp:TextBox ID="PeriodicityCodeInput" runat="server" Width="295px" MaxLength="1"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>      
        </asp:Table>
</asp:Panel>
