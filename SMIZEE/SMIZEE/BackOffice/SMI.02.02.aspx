<%@ Page Title="Inicio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SMI.02.02.aspx.cs" Inherits="SMIZEE.Account.SMI_02_02" %>
...
<asp:Panel ID="OptionsPanel" runat="server" Width="100%" Visible="True">
    <asp:table id="Table4" border="0" runat="server" Width="100%">
        <asp:TableRow id="zonaopcoes">
            ...
            <asp:TableCell id="TableCell3" style="width: 160px;">
...
<asp:Panel ID="SearchPanel" runat="server" Width="100%" Visible="False">
    <asp:Table id="Table2" width="100%" border="0" runat="server">
        ...
        <asp:TableRow>
            <asp:TableCell id="TableCell5" CssClass="entityLabel" style="width: 100px;">
                <asp:Label ID="CompanyIdSearchLabel" runat="server" Text="<%$ Resources:Resource, lID %>"></asp:Label>
            </asp:TableCell>
            <asp:TableCell id="TableCell6" style="width: 160px;">
                <asp:TextBox ID="CompanyIdSearchInput" runat="server" MaxLength="10" Width="140px"></asp:TextBox>
            </asp:TableCell>
            ...
            <asp:TableCell id="Td4" style="width: 300px;">
                <asp:TextBox ID="CompanyDescriptionSearchInput" runat="server" MaxLength="75" Width="300px"></asp:TextBox>
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
</asp:Panel>
        ...
        AutoGenerateColumns="False" BorderWidth="0px" AllowPaging="False" PageSize="10">
            <Columns>
                ...
                <asp:TemplateField ItemStyle-Width="10%" HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Right"   
                    ...
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="CompanyIDLabel" runat="server" Text='<%# Eval("CountryId") %>'></asp:Label>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Left"   
                    ...
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="CompanyNameLabel" runat="server" Text='<%# Eval("Description") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle Wrap="False" />
                    <ItemStyle Wrap="False" />
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Left"   
                    HeaderText="<%$ Resources:Resource, lIsoCode %>" ItemStyle-Wrap="False" 
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="ISOCodeLabel" runat="server" Text='<%# Eval("ISOCode") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle Wrap="False" />
                    <ItemStyle Wrap="False" />
                </asp:TemplateField>
...
<asp:Panel ID="DetailPanel" runat="server" Width="100%" Visible="False" CssClass="xdetail">
        <asp:Table width="100%" runat="server">
            ...
            <asp:TableRow>
                <asp:TableCell style="width: 100px" CssClass="entityLabel">
                    <asp:Literal ID="DescriptionLiteral" runat="server" Text="<%$ Resources:Resource, lDescription %>"></asp:Literal></asp:TableCell>
                <asp:TableCell id="Td6">
                    <asp:TextBox ID="DescriptionInput" runat="server" Width="295px" MaxLength="100"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell style="width: 100px" CssClass="entityLabel">
                    <asp:Literal ID="SmallDescriptionLiteral" runat="server" Text="<%$ Resources:Resource, lSmallDescription %>"></asp:Literal></asp:TableCell>
            ...
            <asp:TableRow>
                <asp:TableCell style="width: 100px" CssClass="entityLabel">
                    <asp:Literal ID="IsoLabel" runat="server" Text="<%$ Resources:Resource, lISOCode %>"></asp:Literal></asp:TableCell>
                <asp:TableCell id="TableCell7">
                    <asp:TextBox ID="IsoInput" runat="server" Width="295px" MaxLength="3"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
</asp:Panel>
