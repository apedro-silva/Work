<%@ Page Title="Inicio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SMI.02.01.aspx.cs" Inherits="SMIZEE.Account.SMI_02_01" %>
    ...
    <asp:table id="TableSearchPanel" border="0" runat="server" Width="100%">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell id="TableCell6"  style="width: 160px;">
                <asp:TextBox ID="CompanyIdSearchInput" runat="server" MaxLength="11" Width="140px"></asp:TextBox>
            </asp:TableCell>
        ...
        AutoGenerateColumns="False" BorderWidth="0px" AllowPaging="False" PageSize="10">
            <Columns>
                ...
                <asp:TemplateField ItemStyle-Width="10%" HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Right"   
                    ...
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="CompanyIDLabel" runat="server" Text='<%# Eval("CompanyId") %>'></asp:Label>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Left"   
                    HeaderText="<%$ Resources:Resource, lCompanyName %>" ItemStyle-Wrap="False" 
                    SortExpression="">
                    <ItemTemplate>
...
<asp:Panel ID="DetailPanel" runat="server" Width="100%" Visible="False" CssClass="xdetail">
        <asp:Table width="100%" runat="server">
            ...
            <asp:TableRow>
                <asp:TableCell style="width: 100px" CssClass="entityLabel">
                    <asp:Literal ID="ExpenseBudgetRatingDescriptionLiteral" runat="server" Text="<%$ Resources:Resource, lCompanyName %>"></asp:Literal></asp:TableCell>
                <asp:TableCell id="Td6">
                    <asp:TextBox ID="CompanyNameInput" runat="server" Width="295px" MaxLength="100"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell style="width: 100px" CssClass="entityLabel">
                    <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:Resource, lDescription %>"></asp:Literal></asp:TableCell>
...
<asp:Panel ID="ConfirmButtonPanel" DefaultButton="btnConfirm" runat="server" Width="100%" Visible="False" CssClass="detail">
    <asp:Table width="100%" runat="server">
            <asp:TableRow>
                <asp:TableCell id="Td7" style="width: 75px">
                    <asp:Button ID="btnConfirm" AccessKey="" runat="server" CommandName="Query" Text="<%$ Resources:Resource, btnConfirm %>" OnClick="OnConfirm"/>
                </asp:TableCell>
