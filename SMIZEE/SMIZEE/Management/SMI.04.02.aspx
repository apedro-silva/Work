<%@ Page Title="Inicio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SMI.04.02.aspx.cs" Inherits="SMIZEE.Management.SMI_04_02" %>
    ...
    <asp:table id="TableSearchPanel" border="0" runat="server" Width="100%">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell id="Td4">
                <asp:TextBox ID="RoleNameSearchInput" runat="server" MaxLength="75" Width="300px"></asp:TextBox>
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
</asp:Panel>
        ...
        AutoGenerateColumns="False" BorderWidth="0px" AllowPaging="False" PageSize="10">
            <Columns>
                ...
                <asp:TemplateField HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Left"   
                    ...
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="RoleNameLabel" runat="server" Text='<%# Eval("RoleName") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle Wrap="False" />
                    <ItemStyle Wrap="False" />
                </asp:TemplateField>
        ...
        <asp:Table width="100%" runat="server">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell id="Td5">
                    <asp:TextBox ID="IdInput" runat="server" Width="395px" MaxLength="75"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell style="width: 100px" CssClass="entityLabel">
                    <asp:Literal ID="RoleDescriptionLiteral" runat="server" Text="<%$ Resources:Resource, lDescription %>"></asp:Literal></asp:TableCell>
                <asp:TableCell id="Td6">
                    <asp:TextBox ID="DescriptionInput" runat="server" Width="395px" MaxLength="75"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
</asp:Panel>
