<%@ Page Title="Inicio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SMI.04.03.aspx.cs" Inherits="SMIZEE.Management.SMI_04_03" %>
...
<asp:Panel ID="SearchPanel" runat="server" Width="100%" Visible="False">
    <asp:table id="TableSearchPanel" border="0" runat="server" Width="100%">
        ...
        <asp:TableRow>
            <asp:TableCell id="Td3" CssClass="entityLabel" style="width: 100px;">
                <asp:Label ID="Label1" runat="server" Text="<%$ Resources:Resource, lService %>"></asp:Label></asp:TableCell>
            <asp:TableCell id="Td4">
                <asp:DropDownList ID="ApplicationPageSearchInput" Width="310px" runat="server"></asp:DropDownList>
            </asp:TableCell>
            <asp:TableCell id="TableCell13" CssClass="entityLabel" style="width: 200px;">
                <asp:Label ID="Label4" runat="server" Text="<%$ Resources:Resource, lUserName %>"></asp:Label></asp:TableCell>
            <asp:TableCell id="TableCell14">
                <asp:TextBox ID="UserNameSearchInput" runat="server" Width="300px"></asp:TextBox>
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell id="TableCell8" CssClass="entityLabel">
                <asp:Label ID="Label2" runat="server" Text="<%$ Resources:Resource, lStartDate %>"></asp:Label></asp:TableCell>
            <asp:TableCell id="TableCell9">
                <ajaxToolkit:CalendarExtender ID="StartDateExtender" Format="dd-MM-yyyy"  runat="server" TargetControlID="StartDateInputControl"/>
                <asp:TextBox ID="StartDateInputControl" runat="server" Width="300px"></asp:TextBox>
            </asp:TableCell>
            <asp:TableCell id="TableCell10" CssClass="entityLabel">
                <asp:Label ID="Label3" runat="server" Text="<%$ Resources:Resource, lEndDate %>"></asp:Label></asp:TableCell>
            <asp:TableCell id="TableCell11">
                <ajaxToolkit:CalendarExtender ID="EndDateExtender" Format="dd-MM-yyyy"  runat="server" TargetControlID="EndDateInputControl"/>
                <asp:TextBox ID="EndDateInputControl" runat="server" Width="300px"></asp:TextBox>
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
</asp:Panel>
        ...
        AutoGenerateColumns="False" BorderWidth="0px" AllowPaging="False" PageSize="10">
            <Columns>
                ...
                <asp:TemplateField ItemStyle-Width="10%" HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Right"   
                    ...
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="AuditIdLabel" runat="server" Text='<%# Eval("AuditId") %>'></asp:Label>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Left"   
                    HeaderText="<%$ Resources:Resource, lUserName %>" ItemStyle-Wrap="False" 
                    SortExpression="">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Left"   
                    HeaderText="<%$ Resources:Resource, lApplicationPage %>" ItemStyle-Wrap="False" 
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="ApplicationPageLabel" runat="server" Text='<%# Eval("ApplicationPage") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle Wrap="False" />
                    <ItemStyle Wrap="False" />
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Left"   
                    HeaderText="<%$ Resources:Resource, lService %>" ItemStyle-Wrap="False" 
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="ServiceDescriptionLabel" runat="server" Text='<%# Eval("ServiceDescription") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle Wrap="False" />
                    <ItemStyle Wrap="False" />
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Left"   
                    HeaderText="<%$ Resources:Resource, lOperation %>" ItemStyle-Wrap="False" 
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="OperationLabel" runat="server" Text='<%# Eval("Description") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle Wrap="False" />
                    <ItemStyle Wrap="False" />
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Left"   
                    HeaderText="<%$ Resources:Resource, lResult %>" ItemStyle-Wrap="False" 
                    SortExpression="">
                    <ItemTemplate>
                       <asp:Label id="ResultLabel" runat="server" Text='<%# Eval("Result") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle Wrap="False" />
                    <ItemStyle Wrap="False" />
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderStyle-Wrap="False" ItemStyle-HorizontalAlign="Right"   
                    HeaderText="<%$ Resources:Resource, lTimestamp %>" ItemStyle-Wrap="False" 
                    SortExpression="">
                    <ItemTemplate>
        ...
        <asp:Table width="100%" runat="server" Border="0">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell id="Td5">
                    <asp:TextBox ID="AuditIdInput" runat="server" Width="395px" MaxLength="75"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="RoleDescriptionLiteral" runat="server" Text="<%$ Resources:Resource, lUserName %>"></asp:Literal></asp:TableCell>
                <asp:TableCell id="Td6">
                    <asp:TextBox ID="UserNameInput" runat="server" Width="395px" MaxLength="75"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:Resource, lApplicationPage %>"></asp:Literal></asp:TableCell>
                <asp:TableCell id="TableCell1">
                    <asp:TextBox ID="ApplicationPageInput" runat="server" Width="395px" MaxLength="75"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:Resource, lService %>"></asp:Literal></asp:TableCell>
                <asp:TableCell id="TableCell12">
                    <asp:TextBox ID="ServiceDescriptionInput" runat="server" Width="395px" MaxLength="200"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:Resource, lOperation %>"></asp:Literal></asp:TableCell>
                <asp:TableCell id="TableCell5">
                    <asp:TextBox ID="OperationInput" runat="server" Width="395px" MaxLength="75"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:Resource, lResult %>"></asp:Literal></asp:TableCell>
                <asp:TableCell id="TableCell6">
                    <asp:TextBox ID="ResultInput" runat="server" Width="395px" MaxLength="75"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="entityLabel">
                    <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:Resource, lTimestamp %>"></asp:Literal></asp:TableCell>
                <asp:TableCell id="TableCell7">
                    <asp:TextBox ID="TimestampInput" runat="server" Width="395px" MaxLength="75"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
</asp:Panel>
